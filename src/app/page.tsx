          ...
          <section className="bg-white dark:bg-green-600">
            <div className="grid max-w-screen-xl px-4 py-8 mx-auto lg:gap-8 xl:gap-0 lg:py-16 lg:grid-cols-12">
              <div className="hidden lg:flex lg:col-span-5">
                <img
                  src="https:e7.pngegg.com/pngimages/880/271/png-clipart-job-scheduler-scheduling-automation-information-technology-process-automation-angle-engineering.png"
                  alt="mockup"
