export default function Footer(){
    return (
      ...
      <h1 className="text-2xl font-bold text-white text-center mb-5"><u>Contact Us</u></h1>
          <div className="md:flex md:justify-between">
              <div className="mb-6 md:mb-0">
             
                  <a href="https:triyas.com" className="flex items-center">
              ...
              <div className="grid grid-cols-2 gap-8 sm:gap-6 sm:grid-cols-3">
                  <div>
                      ...
                      <ul className="text-gray-600 dark:text-gray-400">
                          <li className="mb-4">
                              <a href="https:triays.com/appplication design.com" className="hover:underline">Application Design and Development</a>
                          </li>
                          <li>
                              <a href="https:triyas.com/Cad" className="hover:underline">Cad</a>
                          </li>
                          <li>
                              <a href="https:triyas.com/Cad" className="hover:underline">Staffing</a>
                          </li>
                      </ul>
                  </div>
                  <div>
                      ...
                      <ul className="text-gray-600 dark:text-gray-400">
                          <li className="mb-4">
                              <a href="https:altriar.com" className="hover:underline ">Altair</a>
                          </li>
                          <li>
                              <a href="https:cad.com" className="hover:underline">CAD</a>
                          </li>
                     </ul>
              </div>
                  <div>
          ...
          <div className="sm:flex sm:items-center sm:justify-between">
              <span className="text-sm text-gray-500 sm:text-center dark:text-gray-400"><a href="https:flowbite.com" className="hover:underline">Triyas.com</a>
              </span>
